...
use Edmunds\Vehicle\Type\CategoriesType;
use Edmunds\Vehicle\Type\MakeType;
use Edmunds\Vehicle\Type\ModelType;
use Edmunds\Vehicle\Type\MpgType;
use Edmunds\Vehicle\Type\PriceType;
use Edmunds\Vehicle\Type\TransmissionType;
use Edmunds\Vehicle\Type\ColorCategoryType;
use Edmunds\Vehicle\Type\VinDecoding\EngineType;
use Edmunds\Vehicle\Type\OptionCategoryType;
use Edmunds\Vehicle\Type\YearType;
...
class VinDecodingResponse
{
    ...
    /**
     * @var EngineType
     * @Type("Edmunds\Vehicle\Type\VinDecoding\EngineType")
     */
    private $engine;
     ...
     * @Type("array<Edmunds\Vehicle\Type\ColorCategoryType>")
     */
    private $colors;
